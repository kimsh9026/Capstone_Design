                          ...
                          child: Center(
                              child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Column(
                                      children: <Widget>[
                                        snapshot.data['hobby'] != null || snapshot.data['hobby'] != "" ?
                                          ListTile(
                                            title: Text("Hobby"),
                                            subtitle: Text(snapshot.data['hobby']),
                                          ) : null,
                                        /*
                                        snapshot.data['intro'] != null ?
                                          ListTile(
                                            title: Text("Anout Me"),
                                            subtitle: Text(snapshot.data['intro']),
                                        ) : null,
*/
/*
                                        Container(
                                        ...
                                        snapshot.data['intro'] != null ? Container(
                                            child:ListTile(
                                                title: Text("About me"),
                                                subtitle: Text(snapshot.data['intro'])
                                            )
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Colors.white,
        title: Text(user_info., textAlign : TextAlign.center, style : TextStyle(color: Color.fromRGBO(61, 174, 218, 1))),
        centerTitle: true,
        elevation: 0.0,
        actions:
        <Widget>[
